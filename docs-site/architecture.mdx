...
Six Anchor programs named after major Solana yield protocols, plus a template scaffold. Each implements the same three-instruction surface with protocol-specific PDA seeds and optional constraints (e.g. Drift two-phase withdrawal).
...
| Template | (local) | No-op scaffold for building new adapters |
