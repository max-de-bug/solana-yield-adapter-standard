...
export default function Footer() {
  return (
    <footer className="fixed bottom-0 right-0 left-0 md:left-64 h-10 border-t border-outline-variant flex items-center justify-between px-margin-desktop w-full z-40 bg-surface-container-lowest text-on-surface-variant font-label-sm text-label-sm">
      <div className="font-label-sm text-label-sm uppercase tracking-widest text-on-surface-variant opacity-50 hidden md:block whitespace-nowrap overflow-hidden text-ellipsis">
        © 2026 Solana-Yield Adapter
      </div>
      <div className="flex gap-4 md:gap-6 w-full md:w-auto justify-between md:justify-end ml-auto">
