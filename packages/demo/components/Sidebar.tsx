...
export default function Sidebar() {
  return (
    <aside className="fixed left-0 top-16 h-[calc(100vh-64px-40px)] w-64 border-r border-outline-variant flex flex-col py-6 bg-surface-container-low z-40 hidden md:flex">
