...
pub struct MarginfiVaultState {
    pub authority: Pubkey,
    pub underlying_mint: Pubkey,
    pub total_underlying: u64,
    pub total_shares: u64,
    /// Target protocol program (MarginFi v2 on mainnet).
...
pub const VAULT_STATE_SEED: &[u8] = b"marginfi_vault_state";
pub const VAULT_AUTHORITY_SEED: &[u8] = b"marginfi_vault_authority";
